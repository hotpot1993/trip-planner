...
from third_party.floattrip.core.async_resources import provider_slot
from third_party.floattrip.providers.amap.poi import (
    parse_location,
    normalize_address,
...
def fetch_weather_for_dates(
    ...
    """
    from third_party.floattrip.providers.weather.amap import fetch_forecast
...
async def fetch_weather_for_dates_async(
    ...
    from third_party.floattrip.providers.weather.amap import fetch_forecast_async
