...
from third_party.floattrip.chat.models import DialogueDecision
from third_party.floattrip.core.database import get_conn
from third_party.floattrip.chat.memory_service import ChatMemoryService
from third_party.floattrip.chat.planning_memory import PlanningMemoryMatcher
from third_party.floattrip.core.planning_constraints import compatibility_preferences
from third_party.floattrip.core.travel_memory import ConversationMemoryRepository
from third_party.floattrip.runtime.manager import RunManager
from third_party.floattrip.runtime.models import RunKind, concurrency_key
from third_party.floattrip.runtime.repositories import (
...
class ChatService:
    def __init__(self, manager: RunManager, db_path: str | Path | None = None):
        ...
        from third_party.floattrip.chat.executor import DialogueActionExecutor
